...
public class Level2Materials extends Level {
  ...
  Level next_level;
	...
	public Level2Materials(Model m) {
		...
		commandbox_13 = new CommandBox(210, 100, "get jelly");
		commandbox_14 = new CommandBox(210, 140, "open bottle");
		commandbox_15 = new CommandBox(210, 180, "spread on bread");
		commandbox_16 = new CommandBox(210, 220, "lay bread on plate");
		commandbox_17 = new CommandBox(210, 260, "close bottle");
		commandbox_18 = new CommandBox(210, 300, "close slices of bread to make sandwich");
		commandbox_19 = new CommandBox(210, 340, "return bread");
		commandbox_20 = new CommandBox(210, 380, "place knife in sink");
		commandbox_21 = new CommandBox(210, 420, "place fork in sink");
		commandbox_22 = new CommandBox(210, 460, "get plate");
		commandbox_23 = new CommandBox(210, 500, "place spoon in sink");
		commandbox_24 = new CommandBox(210, 540, "place plate in sink");
